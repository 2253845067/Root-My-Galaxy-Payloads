/*
 * target.h for pa3q-S9380ZCUBCZF1 (SM-S9380, China, S9380ZCUBCZF1 firmware)
 *
 * NOTE: Offsets and p0 fingerprints are copied from pa3q-S9380ZHUBCZF1 as a
 * template. The exploit .so (cve-2026-43499-app.so) was extracted from the
 * upstream APK and is the compiled artifact. Kernel string fields in
 * targets-v2.json need to be verified from a real device (uname -a, getprop).
 */
#ifndef OFFSET_H
#define OFFSET_H

#if defined(APP_PAYLOAD) && APP_PAYLOAD
#define BUILD_VARIANT_LABEL "pa3q-S9370ZCU8CZF1-app-physical-p0-oracle"
#define APP_PHYS_P0_ORACLE 1
#else
#define BUILD_VARIANT_LABEL "pa3q-S9370ZCU8CZF1-root-umh"
#endif
#ifndef BUILD_FINGERPRINT
#define BUILD_FINGERPRINT "samsung/pa3qzhx/pa3q:16/BP4A.251205.006/S9380ZCUBCZF1_OZSBCZF1:user/release-keys"
#endif
...
#define P0_FINGERPRINT_HEADER \
  "targets/pa3q-S9370ZCU8CZF1/p0_fingerprint.h"
#endif
